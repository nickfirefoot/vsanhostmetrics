...
**994 attributes across 31 resource kinds.** Generated by `tools/build_metric_guide.py`; the counts come from the model, the explanations are hand-written.
